	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/ab.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
                ...
                <form class="login100-form validate-form p-b-33 p-t-5" action='create-01-users.php' method='post'>
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if($password_r != $password )
    {
		...
		Print '<script>window.location.assign("create-01-users.php");</script>'; // redirects to login.php
	}
	...
	if ($result->num_rows > 0){
	    while($row = $result->fetch_assoc()){
		    ...
		    if($username == $table_users) // checks if there are any matching fields
	    	{
			    ...
			    Print '<script>window.location.assign("create-01-users.php");</script>'; // redirects to register.php
		    }
	    }
	} 
	...
	{
		$conn->query("INSERT INTO user_info (username, password, admin) VALUES ('$username','$password',0)"); //Inserts the value to table users
